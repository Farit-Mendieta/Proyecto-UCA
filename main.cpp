...
void lectura(){ //esta es la funcion para abrir la hoja de texto donde estan guardado los datos del cliente
    	fstream archivo("tienda.txt"); //sirve como para llamar al archivo
    	string linea;
    	int op;
